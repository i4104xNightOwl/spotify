...
var NzIconService = class _NzIconService extends IconService {
  ...
  onConfigChange() {
    this.nzConfigService.getConfigChangeEventForComponent("icon").pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => {
      this.configDefaultTwotoneColor();
      this.configDefaultTheme();
...
var NzIconDirective = class _NzIconDirective extends IconDirective {
  ...
  changeIcon2() {
    this.setClassName();
    this.ngZone.runOutsideAngular(() => {
      from(this._changeIcon()).pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
        next: (svgOrRemove) => {
          this.ngZone.run(() => {
